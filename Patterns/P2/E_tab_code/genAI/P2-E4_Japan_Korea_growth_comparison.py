"""Extract CAGR comparison for Japan and the Republic of Korea, 2021-2023."""
        ...
        sheet_specs=[{
            ...
            "entities": [
                ...
                },
                {
                    ...
                    "filters": {"TECHNOLOGY_NAME": "GenAI Total", "INVENTOR_COUNTRY": "KR"},
                },
            ],
        }],
    )
    return {"instance_id": "P2-E4", "metric": "CAGR", "tabular_example": rows}
