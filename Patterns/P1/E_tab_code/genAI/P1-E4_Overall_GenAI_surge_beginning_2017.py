"""Extract E.tab for P1-E4: overall GenAI patent surge beginning in 2017."""
...
def extract(include_family_ids: bool = False) -> dict:
    ...
    filters = {"TECHNOLOGY_NAME": "GenAI Total"}
    data = extract_distinct_family_counts(
        ...
        end_year=2023,
        filters=filters,
        count_field="distinct_global_genai_patent_family_count",
        include_family_ids=include_family_ids,
    )
    return {
        "instance_id": "P1-E4",
        "pattern": "Trajectory Shift",
        "entity": "Global GenAI patent families",
