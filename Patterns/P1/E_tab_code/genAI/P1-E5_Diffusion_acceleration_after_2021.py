"""Extract E.tab for P1-E5: diffusion-model patent acceleration after 2021."""
...
def extract(include_family_ids: bool = False) -> dict:
    ...
    filters = {"TECHNOLOGY_NAME": "Diffusion Models"}
    data = extract_distinct_family_counts(
        ...
        end_year=2023,
        filters=filters,
        count_field="distinct_diffusion_model_patent_family_count",
        include_family_ids=include_family_ids,
    )
    return {
        "instance_id": "P1-E5",
        "pattern": "Trajectory Shift",
        "entity": "Diffusion-model patent families",
