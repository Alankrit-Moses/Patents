"""Blackboard-based agentic executor and the exact prompts used in the study."""
...
Your role is to interpret a framework query, maintain the framework state, decide which specialist agent to invoke next, and return final assignments once the query variables have candidate assignments from the specialists.
